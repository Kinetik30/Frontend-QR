...
export default function SessionManager() {
  ...
  return (
    <div className="relative max-w-4xl mx-auto space-y-6 p-4 rounded-xl bg-gradient-to-br from-blue-100 via-blue-50 to-emerald-50/50 dark:from-gray-900 dark:via-blue-900/20 dark:to-gray-900">
